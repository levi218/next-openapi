...
class Style {
  ...
  public style(style: IStyle): Style {
    Object.entries(style).forEach(
      ([property, value]) =>
        (this.properties[property] = `${property}: ${value}`)
    );
    return this;
  }
  ...
  public cloneFont($source, forceOverride?: boolean): Style {
  ...
  public cloneBorder($source, forceOverride?: boolean): Style {
    return this.cloneStyles(
      $source,
...
export class StyleBuilder {
  ...
  public static add(selector: string): Style {
    if (!StyleBuilder.selectorsBuilder.selectors[selector]) {
      StyleBuilder.selectorsBuilder.selectors[selector] = new Style(
        StyleBuilder.selectorsBuilder
      );
    }
  ...
  public static toString(): string {
    let media = '';
    Object.entries(StyleBuilder.mediaSelectorsBuilder).forEach(
      ([selector, selectors]) => {
