...
export class StyleMatcherConfig
  extends Config<StyleMatcherOptions>
  implements StyleMatcherOptions
{
  ...
  private readonly _inputTargetSelector: string =
    '.swagger-ui input[type=text]';
  private readonly _selectTargetSelector: string =
    '.swagger-ui .opblock select';
  private readonly _textAreaTargetSelector: string =
    '.swagger-ui .opblock textarea';
  private readonly _paragraphTargetSelector: string = '.swagger-ui .opblock p';
  private readonly _executeBtnTargetSelector: string =
    '.swagger-ui .opblock .btn.execute';

  private readonly _responseContainerTargetSelector: string =
    '.swagger-ui .opblock .opblock-body .responses-inner';
  private readonly _responseTitleTargetSelector: string =
    '.swagger-ui .opblock .responses-inner > div > h4';
  private readonly _responseHeaderTargetSelector: string =
    '.swagger-ui .opblock .responses-inner h4';
  private readonly _responseTableTargetSelector: string =
    '.swagger-ui .opblock .responses-inner > .responses-table';
  private readonly _responseWrapperTargetSelector: string =
    '.swagger-ui .opblock .responses-wrapper';
  private readonly _responseWrapperResultTargetSelector: string =
    '.swagger-ui .opblock .btn-group + .responses-wrapper';
  private readonly _responseMicrolightTargetSelector: string =
    '.swagger-ui .opblock .microlight';
  private readonly _responseCodeTargetSelector: string =
    '.swagger-ui .opblock .microlight code';
  private readonly _responseClipboardTargetSelector: string =
    '.swagger-ui .opblock .responses-inner .copy-to-clipboard';
  private readonly _responseClipboardBtnTargetSelector: string =
    '.swagger-ui .opblock .responses-inner .copy-to-clipboard button';
  private readonly _responseCurlClipboardTargetSelector: string =
    '.swagger-ui .opblock .responses-inner .curl-command .copy-to-clipboard';
  private readonly _responseDownloadTargetSelector: string =
    '.swagger-ui .opblock .responses-inner .download-contents';

  private readonly _serverResponseHeaderTargetSelector: string =
    '.swagger-ui .opblock .responses-inner .responses-header td.col_header';
  private readonly _serverResponseStatusTargetSelector: string =
    '.swagger-ui .opblock .responses-inner .response .response-col_status';
  private readonly _serverResponseDescriptionTargetSelector: string =
    '.swagger-ui .opblock .responses-inner .response .response-col_description';
  private readonly _serverResponseSubHeaderTargetSelector: string =
    '.swagger-ui .opblock .responses-inner .response h5';

  private readonly _clearBtnTargetSelector: string =
    '.swagger-ui .opblock .btn-group .btn-clear';

  private readonly _operationTagTargetSelector: string =
    '.swagger-ui .opblock-tag[data-tag]';
  private readonly _operationHeaderContainerTargetSelector: string =
    '.swagger-ui .opblock .opblock-section-header';
  private readonly _operationHeaderTargetSelector: string =
    '.swagger-ui .opblock .opblock-section-header h4';
  private readonly _operationHeaderDecorationTargetSelector: string =
    '.swagger-ui .opblock .opblock-section-header h4 span::after';
  private readonly _operationTryOutTargetSelector: string =
    '.swagger-ui .operation-tag-content div.try-out';

  private readonly _descriptionContainerTargetSelector: string =
    '.swagger-ui .opblock .opblock-body .opblock-description-wrapper';
  private readonly _summaryTargetSelector: string =
    '.swagger-ui .operation-tag-content div.opblock .opblock-summary';

  private readonly _modalHeaderContainerTargetSelector: string =
    '.swagger-ui .dialog-ux .modal-ux-header';
  private readonly _modalHeaderTargetSelector: string =
    '.swagger-ui .dialog-ux .modal-ux-header h3';
  private readonly _modalTitleTargetSelector: string =
    '.swagger-ui .dialog-ux .modal-ux-content h4';
  private readonly _modalTitleCodeTargetSelector: string =
    '.swagger-ui .dialog-ux .modal-ux-content .wrapper code';
  private readonly _modalLabelTargetSelector: string =
    '.swagger-ui .modal-ux label';
  private readonly _modalCodeTargetSelector: string =
    '.swagger-ui .modal-ux code';
  private readonly _modalBtnTargetSelector: string =
    '.swagger-ui .modal-ux button';

  private readonly _parametersTableContainerTargetSelector: string =
    '.swagger-ui .opblock .table-container';
  private readonly _parametersHeadTargetSelector: string =
    '.swagger-ui .opblock .table-container table.parameters thead';
  private readonly _parameterNameFieldTargetSelector: string =
    '.swagger-ui .opblock .table-container table.parameters .parameter__name';
  private readonly _parameterTypeFieldTargetSelector: string =
    '.swagger-ui .opblock .table-container table.parameters .parameter__type';
  private readonly _parameterDeprecatedTargetSelector: string =
    '.swagger-ui .opblock .table-container table.parameters .parameter__deprecated';
  private readonly _parameterSourceTargetSelector: string =
    '.swagger-ui .opblock .table-container table.parameters .parameter__in';
  private readonly _parameterRequiredMarkerTargetSelector: string =
    '.swagger-ui .opblock .table-container table.parameters .parameter__name.required span';
  private readonly _parameterRequiredTargetSelector: string =
    '.swagger-ui .opblock .table-container table.parameters .parameter__name.required::after';
  ...
  private readonly _codeBoxSourceSelector: string =
    '[data-section-id] [role=tabpanel]';
  private readonly _dataSectionSourceSelector: string =
    '[data-section-id] > div > div';
  ...
  private readonly _fieldMarkerSourceSelector: string =
    '[kind=field]:first span:first-child';
  private readonly _sanSerifFontSourceSelector: string = 'h2';
  private readonly _alternativeMonospaceFontSourceSelector: string =
    '[kind=field] span';
  ...
  private readonly _authBtnSourceSelector: string =
    'a[href*="swagger.json"]:eq(0)';
  private readonly _httpVerbSourceSelector: string =
    '[data-section-id] .http-verb';

  public constructor(
    cfg: StyleMatcherOptions,
    swaggerConfig: SwaggerConfig,
    redocConfig: RedocTryItOutConfig
  ) {
    super(cfg);
  ...
  public get $requiredFieldSource() {
  ...
  public get $alternativeMonospaceFontSource() {
  ...
  public get defaultBackgroundColor(): string {
    const bg =
      $(this.apiContentSourceSelector).css('background-color') || 'white';
